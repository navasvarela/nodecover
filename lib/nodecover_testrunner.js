/**
*	Reporter based on the default reporter by Nodeunit.
*
*/
...
var nodeunit = require('nodeunit'),
    ...
    track = require('./track'),
    path = require('path');
    AssertionError = require('nodeunit').assert.AssertionError;
...
exports.run = function (files, options) {
    ...
    nodeunit.runFiles(paths, {
        ...
        testDone: function (name, assertions) {
            ...
            var thisend = end || new Date().getTime();
            var duration = thisend - start;
            if (assertions.failures()) {
                console.log(
